...
Deno.serve(async(req:Request)=>{
  ...
  const requiredAgentVersion="desktop-0.4.8";
  ...
  return reply({
    ...
    agent:{
      ...
      release_url:"https://github.com/a-codeadlerfurtado/agency-ops-dashboard/releases/download/relato-package-v2026.09.25.3/RelatoAI-Desktop-SDR.exe"
    },
