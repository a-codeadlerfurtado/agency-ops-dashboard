-- Wrapped v2: Central de Trabalho excluida de toda evidencia e cobertura.
...
begin
  ...
  select jsonb_build_object(
    ...
    'excluded_sources',jsonb_build_array('work_items','work_item_events'),
    'source_policy',jsonb_build_object('work_center_included',false),
