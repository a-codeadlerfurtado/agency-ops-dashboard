...
revoke all on function agency_ops.resolve_onboarding_required_alert(uuid,text,text,text,text,text,text) from public,anon,authenticated;
grant execute on function agency_ops.resolve_onboarding_required_alert(uuid,text,text,text,text,text,text) to service_role;
