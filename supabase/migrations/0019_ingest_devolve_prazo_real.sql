-- Com horario de atendimento, o prazo pode vencer daqui a minutos ou so na
-- segunda-feira. O Worker precisa da DATA, nao de um numero fixo de segundos.
...
begin
  ...
  return jsonb_build_object(
    ...
    -- mantido por compatibilidade; o Worker prefere sla_expira_em
