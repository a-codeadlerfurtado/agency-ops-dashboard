...
<template>
  <div
    class="conversation relative cursor-pointer group grid gap-4 items-center px-3 h-12 border-transparent hover:z-[1] mx-2 my-0.5 rounded-xl transition-all"
    :class="{
      ...
      'hover:bg-[#eaf4f7] dark:hover:bg-n-alpha-1': !isActiveChat && !selected,
