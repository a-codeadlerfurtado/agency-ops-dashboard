...
const TENURE_LABEL: Record<string, string> = { ate_1m: "Até 1 mês", m1_2: "1 a 2 meses", m2_3: "2 a 3 meses", m3_4: "3 a 4 meses", m4_5: "4 a 5 meses", m5_6: "5 a 6 meses", mais_6m: "+ 6 meses" };
const CHART_COLORS = ["#64a8ff", "#31d49b", "#f7c95c", "#a98bff"];

function PortfolioChart({ series, kind, unit }: { series: Array<{ label: string; values: number[] }>; kind: "line" | "bar"; unit?: string }) {
...
function PortfolioCenter({ portfolio, openClient }: { portfolio: Row | null; openClient: (id: string) => void }) {
