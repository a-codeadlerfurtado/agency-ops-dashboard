...
export default function Dashboard() {
  ...
  return (
    <main className="shell">
      ...
      {view === "team" && <TeamCenter team={data?.team || []} teamMembers={Number(kpis.team_members || 0)} openClient={openClient} />}
...
function TeamCenter({ team, teamMembers, openClient }: { team: TeamMember[]; teamMembers: number; openClient: (id: string) => void }) {
