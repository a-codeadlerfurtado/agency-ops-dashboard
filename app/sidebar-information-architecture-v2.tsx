...
const GROUPS: GroupDef[] = [
  { key: "inicio", label: "IN├ìCIO", description: "Prioridades, rotina e execu├º├úo do dia", order: 100 },
  { key: "clientes", label: "CLIENTES", description: "Carteira, jornada, relacionamento e briefings", order: 200 },
  { key: "performance", label: "TR├üFEGO & RESULTADOS", description: "Campanhas, Meta, saldos e intelig├¬ncia de m├¡dia", order: 300 },
  { key: "gestao", label: "GEST├âO", description: "Equipe, capacidade, diagn├│stico, auditoria e financeiro", order: 400 },
  { key: "comercial", label: "COMERCIAL", description: "Pr├®-clientes, funil e acompanhamento comercial", order: 500 },
  { key: "criativo", label: "CONTE├ÜDO & CRIATIVO", description: "Criativos, roteiros, v├¡deos e intelig├¬ncia criativa", order: 600 },
  { key: "sistemas", label: "SISTEMAS & IA", description: "IA, Relato, automa├º├Áes, ClickUp e seguran├ºa", order: 700 },
];
