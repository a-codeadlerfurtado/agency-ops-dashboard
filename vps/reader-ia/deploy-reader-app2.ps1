...
$appCfg=New-DockerConfig "reader-ia-app-v2-$stamp" (Join-Path $dir 'app-v2-mobile.mjs')
...
$reader=@{
  ...
  TaskTemplate=@{
    ContainerSpec=@{
      ...
      Env=@('PORT=8080','TRANSLATE_URL=http://reader-ia-translate:5000','TTS_URL=http://reader-ia-tts:8880','OLLAMA_URL=http://reader-ia-gemma:11434','QWEN_URL=http://reader-ia-llm:11434','TRANSLATION_MODEL=translategemma:4b','CACHE_ROOT=/cache','LIBRARY_ROOT=/library')
      Mounts=@(@{Type='volume';Source='readerpro-reader-cache';Target='/cache'},@{Type='volume';Source='readerpro-library';Target='/library';ReadOnly=$true})
      Configs=@(
