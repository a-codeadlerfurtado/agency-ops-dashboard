...
import { detectarTemas, detectarConsultaClientesOperacionais, detectarConsultaLifecycle, contextoDeVocabulario, confirmacaoDeLeitura, temTemaOperacionalExplicito } from "./intent.ts";
